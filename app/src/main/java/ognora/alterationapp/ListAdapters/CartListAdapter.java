    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((CartActivity)context).viewModel.updateCount(Integer.parseInt((String) holder.qty.getText()), arrayList.get(position).getProduct_id());
            }
        });
        ...
        holder.minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                holder.qty.setText(String.valueOf(Integer.parseInt((String) holder.qty.getText())-1));
                if(Integer.parseInt((String) holder.qty.getText()) == 0)
                {
                    ((CartActivity)context).viewModel.removeFromCart(arrayList.get(position));
                    arrayList.remove(position);
                    notifyDataSetChanged();
